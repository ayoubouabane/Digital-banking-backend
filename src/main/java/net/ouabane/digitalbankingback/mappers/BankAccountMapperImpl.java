package net.ouabane.digitalbankingback.mappers;

import net.ouabane.digitalbankingback.dtos.AccountOperationDTO;
...
import net.ouabane.digitalbankingback.entities.AccountOperation;
